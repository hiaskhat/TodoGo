...
class CategoryViewController: SwipeTableViewController {
    ...
    override func viewDidLoad() {
        ...
        //For Navigation Bar bsckground color change
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let categoryColor = UIColor(hexString: categories?[indexPath.row].color ?? "white") else {fatalError()}
        
        cell.backgroundColor = categoryColor
        
        cell.textLabel?.textColor = ContrastColorOf(categoryColor, returnFlat: true)
//        if let cellColor = cell.backgroundColor {
//            do {
//                try realm.write {
//                    categories?[indexPath.row].color = cellColor.hexValue()
//                }
//            } catch {
//                print("Error saving cell color, \(error)")
//            }
//        }
        return cell
    }
